...
import java.util.Objects;
 ...
 abstract class Human {
    ...
    Human(String name, String surname, int year, int iq, Pet pet, String[] schedule) {
        this.name = name;
        this.surname = surname;
        this.year = year;
        this.iq = iq;
    ...
    Human(String name, String surname, int year, int iq, Pet pet, String[] schedule, Family family) {
        this.name = name;
        this.surname = surname;
        this.year = year;
        this.iq = iq;
